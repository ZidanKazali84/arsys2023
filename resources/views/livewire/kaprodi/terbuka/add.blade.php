<div>
   ...
   <x-adminlte-button theme="info" class="btn btn-sm btn-success" icon="far fa-light fa-edit" wire:click="$emitUp('uploadAddData')" label="Submit" style="max-width: 150px;"/>
</div>
<style>
    .bg-black {
